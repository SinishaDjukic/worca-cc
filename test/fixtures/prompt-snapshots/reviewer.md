...
- Write **review** to: <PIPELINE_DIR>/steps/n_reviewer-c2/impl-review-cycle2.md
- Write the **verdict** JSON (machine-readable) to: <PIPELINE_DIR>/steps/n_reviewer-c2/impl-review-cycle2.json

### Step folder

- Your step folder for this execution: <PIPELINE_DIR>/steps/n_reviewer-c2
...
MOCK_CYCLE: 2
MOCK_BASE: feature
MOCK_STEP_DIR: <PIPELINE_DIR>/steps/n_reviewer-c2
MOCK_OUT: <PIPELINE_DIR>/steps/n_reviewer-c2/impl-review-cycle2.md
MOCK_JSON: <PIPELINE_DIR>/steps/n_reviewer-c2/impl-review-cycle2.json
MOCK_IN: /abs/plan.md
