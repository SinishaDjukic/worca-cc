...
- Write **review** to: <WORCA_HOME>/store/<STORE_KEY>/reviews/01-01-26-feature-impl-review.md
- Write the **verdict** JSON (machine-readable) to: <PIPELINE_DIR>/impl-review-cycle2.json
...
MOCK_CYCLE: 2
MOCK_BASE: feature
MOCK_OUT: <WORCA_HOME>/store/<STORE_KEY>/reviews/01-01-26-feature-impl-review.md
MOCK_JSON: <PIPELINE_DIR>/impl-review-cycle2.json
MOCK_IN: /abs/plan.md
