...
Review the implementation PLAN against the original request and the real codebase. Do NOT rewrite the plan. Only critical/major block (the planner then revises).
...
- Write **review** to: <PIPELINE_DIR>/steps/n_planReviewer-c2/plan-review-cycle2.md
- Write the **verdict** JSON (machine-readable) to: <PIPELINE_DIR>/steps/n_planReviewer-c2/plan-review-cycle2.json

### Step folder

- Your step folder for this execution: <PIPELINE_DIR>/steps/n_planReviewer-c2
...
MOCK_ROLE: plan-review
MOCK_CYCLE: 2
MOCK_BASE: feature
MOCK_STEP_DIR: <PIPELINE_DIR>/steps/n_planReviewer-c2
MOCK_OUT: <PIPELINE_DIR>/steps/n_planReviewer-c2/plan-review-cycle2.md
MOCK_JSON: <PIPELINE_DIR>/steps/n_planReviewer-c2/plan-review-cycle2.json
MOCK_IN: /abs/plan.md
