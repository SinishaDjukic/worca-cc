...
- Write **plan** (also **revise**) to: <PIPELINE_DIR>/steps/n_refiner-c2/plan.md
- Write the **verdict** JSON (machine-readable) to: <PIPELINE_DIR>/steps/n_refiner-c2/refine-review-cycle2.json

### Step folder

- Your step folder for this execution: <PIPELINE_DIR>/steps/n_refiner-c2
...
MOCK_CYCLE: 2
MOCK_BASE: feature
MOCK_STEP_DIR: <PIPELINE_DIR>/steps/n_refiner-c2
MOCK_OUT: <PIPELINE_DIR>/steps/n_refiner-c2/plan.md
MOCK_JSON: <PIPELINE_DIR>/steps/n_refiner-c2/refine-review-cycle2.json
MOCK_IN: /abs/plan.md
