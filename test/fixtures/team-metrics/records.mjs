export function makeRecord({
  id, startedAt = '2026-09-10T10:00:00Z', usd = 1, result = 'done', wallMs = 1000, activeMs = 800,
  ...
  workspace = 'IoT SP Platform', touched = [], files = null, title = `run ${id}`, models = ['claude-opus-5'],
}) {
  return {
    ...
    target: kind === 'workspace' ? { kind, workspace, projects: ['acme/gateway', 'acme/console'], touched } : { kind, project },
