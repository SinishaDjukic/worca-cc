...
test('VIEW_NAMES is the 13-entry array with composer preserved + projects + stats + team-metrics + getting-started (plugins/guardrails/models are Settings tabs)', () => {
  assert.match(js, /const VIEW_NAMES = \['new', 'getting-started', 'running', 'history', 'stats', 'team-metrics', 'composer', 'workspaces', 'workspace-create', 'agents', 'agent-create', 'projects', 'settings'\];/);
});
