...
test('VIEW_NAMES is the 14-entry array with composer preserved + projects + stats + team-metrics + team-policy + getting-started (plugins/guardrails/models are Settings tabs)', () => {
  assert.match(js, /const VIEW_NAMES = \['new', 'getting-started', 'running', 'history', 'stats', 'team-metrics', 'team-policy', 'composer', 'workspaces', 'workspace-create', 'agents', 'agent-create', 'projects', 'settings'\];/);
});
