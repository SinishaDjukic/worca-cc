...
test('the toggle stays OUT of <nav>, which keeps exactly 11 buttons (10 routes + the mode item)', () => {
  ...
  assert.equal((nav.match(/<button type="button"/g) || []).length, 12);   // + interface mode, + Schedules
