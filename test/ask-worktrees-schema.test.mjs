...
// P4/T1: the v21 ask_worktrees table (ask-worca-worktrees-design.md §4) —
// columns, FK cascade wiring, version stamp, and the schemaGaps self-heal entry.
...
test('v21: ask_worktrees exists with the spec columns and cascades from ask_threads', () => {
  getDb();
